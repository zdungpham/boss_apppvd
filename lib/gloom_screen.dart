...
class GloomScreen extends StatefulWidget {
  const GloomScreen({super.key});
  @override
  State<GloomScreen> createState(){
    return  _GloomScreenState();
  }
}

class _GloomScreenState extends State<GloomScreen> {
  int choosePhase = 0;
  late Timer timer;
  int countDown = 150;
